USE minus;
ALTER TABLE userprofile  ADD COLUMN is_business INT NOT NULL DEFAULT 0;
ALTER TABLE blurbs_blurb  ADD COLUMN is_user_business INT DEFAULT 0;
UPDATE userprofile SET is_business = 0;
UPDATE blurbs_blurb SET is_user_business = 0;
ALTER TABLE userprofile MODIFY hide_birthdate TINYINT(1) DEFAULT 0;
